...
namespace College.Areas.Admin.Controllers
{
    public class ManagersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Image,Birthday,PhoneNumber,Email")] Manager manager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Image,Birthday,PhoneNumber,Email")] Manager manager)
        {
            if (ModelState.IsValid)
            {
