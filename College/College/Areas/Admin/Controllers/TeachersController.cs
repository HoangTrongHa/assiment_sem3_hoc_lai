...
namespace College.Areas.Admin.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Image,Birthday,PhoneNumber,Email")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Image,Birthday,PhoneNumber,Email")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
